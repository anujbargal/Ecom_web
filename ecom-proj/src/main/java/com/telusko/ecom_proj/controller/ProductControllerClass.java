...
public class ProductControllerClass {
    ...
    public ResponseEntity<byte[]> getImageByProductId(@PathVariable int productId) {
        ...
        // Use org.springframework.http.MediaType instead
        return ResponseEntity.ok()
                .contentType(MediaType.valueOf(product.getImageType()))  // Corrected usage of MediaType
                .body(imageFile);
    }
